    ...
    public function run()
    {
        ...
        if (($handle = fopen($files, "r")) !== FALSE) {
            ...
            while (($data = fgetcsv($handle, 1000, ";")) !== FALSE) {
                ...
                Storage::disk('public')->put("kursk-engelsa-".$data[0].".svg", file_get_contents(public_path('planes/kursk/'.$data[0].'.svg')), 'public');
                ...
                $main_data[] =
                    [
                        ...
                        'flor' => intval($data[5]),
                        'rooms' => intval($rooms),
                        'plan_img' => Storage::url("kursk-engelsa-".$data[0].".svg"),
