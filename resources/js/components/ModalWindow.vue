        ...
        <div class="popup">
            ...
            <form class="sending_form" action="/send_consult" method="POST">
                ...
                <div class="control_wrap">
                    <button class="bg-sred text-white text-center px-5 py-2 rounded-lg text-xs ssm:text-xs xl:text-sm" @click.prevent="sendMsg()">Отправить</button> <div v-show="showLoader" class="loader"></div>
                </div>
